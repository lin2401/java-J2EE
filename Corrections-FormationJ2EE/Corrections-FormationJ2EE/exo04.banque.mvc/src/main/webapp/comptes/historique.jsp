...
<body class="container-fluid elbody">
  ...
  <div class="row">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form id="frmListeOperations" name="frmListeOperations" action="<c:url value="/ServletHistorique"/>" method="post">
            ...
            <input type="hidden" name="inNumeroCompte" value="<c:out value="${requestScope.cptId}"/>" />
              ...
              <tbody>
                <tr>
                  <td class="text-center">
                    <label for="inDateDebut">Du</label> <input type="text" id="inDateDebut" name="inDateDebut" maxlength="10" size="10" value="<c:out value="${requestScope.pDateDebut}"/>" style="margin-right: 5px" />
                    <label for="inDateFin" style="margin-left: 20px">Au</label> <input type="text" name="inDateFin" id="inDateFin" maxlength="10" size="10" value="${requestScope.pDateFin}" style="margin-right: 5px"/>
                  </td>
                  <td class="text-center">
                    <label for="inCredit">Crédit</label>
                    <input type="checkbox" name="inCredit" id="inCredit" <c:if test="${!empty requestScope.pCredit}">checked</c:if> value="true"/>
                    <br/>
                    <label for="inDebit">Débit</label>
                    <input type="checkbox" name="inDebit" id="inDebit" <c:if test="${!empty requestScope.pDebit}">checked</c:if> value="true"/>
                  </td>
                </tr>
              </tbody>
            </table>
    ...
    <section class="col-xs-12 col-sm-8 col-sm-offset-2">
      ...
      <div class="panel panel-default">
        <div class="panel-heading text-center">Historique de vos op&eacute;rations effectu&eacute;es sur le compte n&deg; <c:out value="${requestScope.cptId}" /></div>
        <div class="panel-body">
